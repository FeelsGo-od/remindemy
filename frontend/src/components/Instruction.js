        ...
        <div className='instruction'>
            <div className={`instruction-content ${showInstruction ? 'active' : ''}`}>
                ...
                <div className={`hidden-block ${showInstruction ? 'active' : ''}`}>
                    ...
                    <p className='align-left pt-23'>3. You can add text, images, or link to the topic</p> {/* you want this app to remind you. */}
                    <p className="align-left pt-23">Forgot the password? Restore it with your email.</p>
