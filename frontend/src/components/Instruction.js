        ...
        <div className='instruction'>
            <div className="instruction-content">
                ...
                <div className={`hidden-block ${showInstruction ? 'active' : ''}`}>
                    ...
                    <p className='align-left w-40 pt-23'>1. <a href='register'>Create new account</a> or <a href='/login'>login</a></p>
                    <p className='align-left w-40 pt-23'>2. Add new topic(s) on profile page</p>
